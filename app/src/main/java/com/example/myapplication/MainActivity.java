...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    public void login(View view) {
        ...
        if (userName.equals("") || password.equals("")){
            Toast.makeText(MainActivity.this, "Kérjük, minden mezőt töltsön ki", Toast.LENGTH_LONG).show();
        } else {
            auth.signInWithEmailAndPassword(userName, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(MainActivity.this, "A felhasználót nem sikerült bejelentkeztetni:" + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
